...
*DECK DPIGMR
     ...
     +   DL, RHOL, NRMAX, B, BNRM, X, XL, ITOL, TOL, IUNIT, IFLAG, ERR)
...
C     .. Scalar Arguments ..
     ...
     +        MAXLP1, N, NMSL, NRMAX, NRSTS
C     .. Array Arguments ..
      DOUBLE PRECISION B(*), DL(*), HES(MAXLP1,*), Q(*), R0(*),
     +                 RPAR(*), SR(*), SZ(*), V(N,*), WK(*), X(*),
     +                 XL(*), Z(*)
      INTEGER IPAR(*)
C     .. Subroutine Arguments ..
...
C############################################
C Output the error at each iterative step
        print *,LL,'err= ',err
C############################################
...
C     .. Scalar Arguments ..
      ...
      INTEGER ISYM, JPRE, JSCAL, LGMR, MAXLP1, N, NMSL
C     .. Array Arguments ..
      DOUBLE PRECISION HES(MAXLP1,*), Q(*), RPAR(*), SZ(*),
...
C     .. Scalar Arguments ..
     ...
     +        MAXL, MAXLP1, N, NMSL
C     .. Array Arguments ..
      DOUBLE PRECISION B(*), DZ(*), HES(MAXLP1, MAXL), Q(*), R(*),
